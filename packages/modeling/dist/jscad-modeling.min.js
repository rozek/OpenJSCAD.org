...
const vectorText=require("./vectorText"),text=(t,e)=>{const o=vectorText(t,e);return o.map(t=>(t=>path2.fromPoints({close:!1},t))(t))};module.exports=text;

},{"./vectorText":390}],388:[function(require,module,exports){
